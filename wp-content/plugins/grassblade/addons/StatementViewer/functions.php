...
function grassblade_statementviewer($attr)
{
	...
	wp_enqueue_script('grassblade-sv-TinCanViewer', plugins_url( 'scripts/XAPIViewer.js' , __FILE__ ), array('jquery', 'grassblade-sv-tincan','grassblade-sv-config' ), GRASSBLADE_VERSION);            
