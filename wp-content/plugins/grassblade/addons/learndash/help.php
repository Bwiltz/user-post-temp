...
echo sprintf(__("If you are using GrassBlade LRS and have enabled Completion Tracking. Following information related to xAPI Content is passed back to LearnDash: <br>
	...
	The following article will help you setup Completion Tracking for LearnDash: <br> %s",'grassblade'), "<a href='https://nextsoftwaresolutions.zendesk.com/hc/en-us/articles/204743875-Using-GrassBlade-Completion-Tracking-With-LearnDash' target='_blank'>".__("Using Completion Tracking with LearnDash","grassblade")."</a>"); ?>
